...
function generateIDCard($studentData) {
    ...
    if (!empty($studentData['profile_image']) && file_exists(__DIR__ . '/../' . $studentData['profile_image'])) {
        $pdf->Image(__DIR__ . '/../' . $studentData['profile_image'], $photoX, $photoY, $photoSize, $photoSize, '', '', '', true, 150, '', false, false, 1);
    } else {
